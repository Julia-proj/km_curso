    ...
    <section id="results" className="bg-[#FAF7F4] px-4 py-12 sm:px-6 sm:py-16 md:py-20 lg:py-24">
      <div className="mx-auto max-w-6xl">
        ...
        <div
          ...
          className="no-scrollbar -mx-4 mt-4 flex snap-x snap-mandatory gap-2 overflow-x-auto px-4 pb-4 scroll-smooth touch-pan-x sm:-mx-6 sm:gap-3 sm:px-6 sm:pb-4 md:mt-5 md:gap-4 lg:mx-0 lg:grid lg:grid-cols-3 xl:grid-cols-5 lg:overflow-visible lg:px-0 lg:pb-0"
        >
