        ...
        >
          <div className="flex items-start gap-3 lg:hidden">
            <div className="flex gap-2 shrink-0">
              ...
              <div className="relative w-[108px] h-[135px] rounded-xl overflow-hidden">
                <Image alt="Елена Александрова" src="/images/foto2.png" fill className="object-cover object-top" sizes="108px" />
              </div>
            </div>
            <div className="pt-1">
          ...
          <div className="hidden lg:block">
            ...
            <div className="relative ml-auto mt-2 w-[86%] aspect-[4/5] rounded-xl overflow-hidden">
              <Image alt="Елена Александрова" src="/images/foto2.png" fill className="object-cover object-[center_18%]" sizes="(min-width: 1280px) 260px, 25vw" />
            </div>
            <div className="mt-4">
              <div className="km-eyebrow text-muted-foreground">Автор курса</div>
