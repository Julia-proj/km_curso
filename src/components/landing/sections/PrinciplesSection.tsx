...
export function PrinciplesSection() {
  return (
    <section id="program" className="bg-[#1A1A1A] px-5 py-16 text-white sm:px-6 md:py-24">
      <div className="mx-auto max-w-6xl">
        <motion.div {...fadeUp()} className="mb-10 max-w-2xl sm:mb-12 md:mb-14">
          <p className="mb-3 font-sans text-xs font-medium text-[#D29B9B] sm:text-sm">Что важно понимать</p>
        ...
        <div className="grid items-stretch gap-3 sm:gap-4 md:grid-cols-3">
          {principleCards.map((card, index) => (
            ...
            >
              ...
              <p className="mt-3 font-sans text-sm leading-relaxed text-white/65 md:text-base">{card.body}</p>
            </motion.article>
          ))}
        </div>
      </div>
