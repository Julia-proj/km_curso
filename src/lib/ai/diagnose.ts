...
9. ВСЕ текстовые поля (visible_signs, self_care_priorities, summary) пиши на
   грамотном русском языке. ЗАПРЕЩЕНО: транслит английских слов ("фризз",
   "волюм", "детокс" как признак) и кальки ("тупость" вместо "тусклость").
   Используй естественные русские формулировки: пушистость, сухость, тусклость,
   ломкость, секущиеся кончики, жирность корней, потеря объёма.
10. self_care_priorities это ОСМЫСЛЕННЫЕ ДЕЙСТВИЯ по уходу (что делать и зачем),
    а не фразы из описаний продуктов и не отдельные свойства средств.
    ЗАПРЕЩЕНО писать пункты вроде "лёгкое расчёсывание", "глубокое очищение",
    "питание и блеск" - это рекламные фичи, а не рекомендации.
    Каждый пункт это законченный совет, например:
    - "Увлажняй длину маской 1-2 раза в неделю"
    - "Наноси термозащиту перед феном и утюжком"
    - "Подбери мягкий шампунь по типу кожи головы"
    - "Подрежь секущиеся кончики, чтобы остановить ломкость"
    - "Реже пользуйся горячей укладкой, дай волосам отдых"
